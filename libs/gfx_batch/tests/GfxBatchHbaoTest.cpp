...
const struct TestDataType {
  const char* name;
  const char* filename;
  gfx_batch::HbaoType algType;
  gfx_batch::HbaoConfiguration config;

  Mn::Float maxThreshold = 0.0f;
  Mn::Float meanThreshold = 0.0f;
} TestData[]{
    // Perspective projection
    {"classic, defaults", "hbao-classic", gfx_batch::HbaoType::Classic,
     gfx_batch::HbaoConfiguration{}},
    {"classic, AO special blur", "hbao-classic-sblur",
     gfx_batch::HbaoType::Classic,
     gfx_batch::HbaoConfiguration{}.setUseSpecialBlur(true), 1.0f, 0.1f},
    ...
    {"cache-aware, defaults", "hbao-cache",
     gfx_batch::HbaoType::CacheAware, gfx_batch::HbaoConfiguration{}},
    {"cache-aware, AO special blur", "hbao-cache-sblur",
     gfx_batch::HbaoType::CacheAware,
     gfx_batch::HbaoConfiguration{}.setUseSpecialBlur(true), 1.0f, 0.1f},
    ...
    {"cache-aware, layered with image load store", "hbao-cache-layered",
     gfx_batch::HbaoType::CacheAware,
     gfx_batch::HbaoConfiguration{}.setUseLayeredImageLoadStore(true)},
    {"cache-aware, layered with image load store, AO special blur",
     "hbao-cache-layered-sblur", gfx_batch::HbaoType::CacheAware,
     gfx_batch::HbaoConfiguration{}
    ...
    {"cache-aware, layered with geometry shader", "hbao-cache-geom",
     gfx_batch::HbaoType::CacheAware,
     gfx_batch::HbaoConfiguration{}.setUseLayeredGeometryShader(true)},
    {"cache-aware, layered with geometry shader, AO special blur",
     "hbao-cache-geom-sblur", gfx_batch::HbaoType::CacheAware,
     gfx_batch::HbaoConfiguration{}
...
TestDataType BenchData[]{
    {"classic, defaults", "hbao-classic", gfx_batch::HbaoType::Classic,
     gfx_batch::HbaoConfiguration{}},
    {"classic, no blur", "hbao-classic", gfx_batch::HbaoType::Classic,
     gfx_batch::HbaoConfiguration{}.setNoBlur(true)},
    {"cache-aware, defaults", "hbao-cache",
     gfx_batch::HbaoType::CacheAware, gfx_batch::HbaoConfiguration{}},
    {"cache-aware, no blur", "hbao-cache", gfx_batch::HbaoType::CacheAware,
     gfx_batch::HbaoConfiguration{}.setNoBlur(true)},
    {"cache-aware, AO special blur", "hbao-cache-sblur",
     gfx_batch::HbaoType::CacheAware,
     gfx_batch::HbaoConfiguration{}.setUseSpecialBlur(true), 1.0f, 0.1f},
...
void GfxBatchHbaoTest::testHBAOData(const TestDataType& data,
                                    Cr::Containers::StringView filename,
                                    const Projection& projData) {
  if ((data.config.flags() & gfx_batch::HbaoFlag::LayeredImageLoadStore) &&
      !(
  ...
  gfx_batch::Hbao hbao{
      gfx_batch::HbaoConfiguration{data.config}.setSize(Size)};
  MAGNUM_VERIFY_NO_GL_ERROR();
...
void GfxBatchHbaoTest::benchmarkHBAOData(const TestDataType& data,
  ...
  gfx_batch::Hbao hbao{
      gfx_batch::HbaoConfiguration{data.config}.setSize(BenchImageSize)};
  MAGNUM_VERIFY_NO_GL_ERROR();
